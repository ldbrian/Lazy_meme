...
export default function Home() {
  ...
  const achievements = [
    ...
    { id: 3, name: t.home.achievement3, icon: "fa-image", color: "bg-[#F9A66C]" },
  ];
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        ...
        <section className="mb-12">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
            ...
            >
              查看全部 <i className="fas fa-chevron-right ml-1 text-sm"></i>
            </motion.a>
          </div>
        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            >
              <h3 className="text-2xl font-bold text-[#4A6163] mb-6">学习路径推荐</h3>
              <ul className="space-y-4">
                {[
                  { step: 1, title: "基础热词学习", color: "bg-[#F17A7E]/20", textColor: "text-[#F17A7E]" },
                  { step: 2, title: "文化差异理解", color: "bg-[#F9A66C]/20", textColor: "text-[#F9A66C]" },
                  { step: 3, title: "网络梗图解析", color: "bg-[#4A6163]/20", textColor: "text-[#4A6163]" },
                ].map((item) => (
                  <motion.li 
                    key={item.step}
                    whileHover={{ x: 5 }}
